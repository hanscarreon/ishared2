  ...
  <section id="container" class="">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu active">
            ...
            <ul class="sub">
              ...
              <li class="active"><a class="" href="approved.php">Approved Activation</a></li>
            </ul>
          </li>
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="icon_cart_alt "></i>Approved Order's</h3>
            <ol class="breadcrumb">
              <li><i class="icon_cart_alt "></i><a href="order.php">Records</a></li>
          ...
          <div class="col-lg-9 col-md-12">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h2><i class="icon_cart_alt"></i><strong>Approved  Order's</strong></h2>
