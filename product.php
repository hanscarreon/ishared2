  ...
  <section id="container" class="">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu ">
            ...
            <ul class="sub">
              ...
              <li class=""><a class="" href="approved.php">Approved Activation</a></li>
            </ul>
          </li>
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="icon_tag_alt "></i>Products</h3>
            <ol class="breadcrumb">
              <li><i class="icon_tag_alt"></i><a href="order.php">List</a></li>
              <li><i class="fa fa-laptop"></i>Records</li>
            </ol>
          </div>
        </div>

     <a class="btn btn-success" href="" title="Bootstrap 3 themes generator" style="margin-bottom: 15px"><span class="icon_plus_alt"></span> Success</a>
        ...
        <section class="panel">
              <header class="panel-heading tab-bg-primary ">
                <ul class="nav nav-tabs">
                  <li class="active">
                    <a data-toggle="tab" href="#home">Entry Product</a>
                  </li>
                  <li class="">
                    <a data-toggle="tab" href="#about">Maintenance Product</a>
                  </li>
                </ul>
              </header>
